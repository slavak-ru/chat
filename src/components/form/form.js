...
export default class Form {
  ...
  /**
		* @method render()
		* @description Public method - create inners DOM-elements (inputs and submit button) in theForm.
	*/
  render() {
  ...
  /**
		...
		* @description Inner method - remove Error class from the from form-elements if value isn'tempty.
	*/
